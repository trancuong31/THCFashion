...
public class AdapterChatUser extends RecyclerView.Adapter<AdapterChatUser.Viewholder> {
    private Context context;
    private ArrayList<Chat> list;
    private String typeUser = "0";
    private int typeAdmin = 1;

    public AdapterChatUser(Context context, ArrayList<Chat> list, String typeUser) {
