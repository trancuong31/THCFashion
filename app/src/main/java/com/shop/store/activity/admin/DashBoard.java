...
import com.shop.store.activity.LogIn;
import com.shop.store.utilities.AccountSessionManager;

public class DashBoard extends AppCompatActivity {

    MaterialCardView user, product, category, store, discount, statis, productImg, payment,chat;
    ImageView btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chat = findViewById(R.id.frameListChat);

        chat.setOnClickListener(v->{
            startActivity(new Intent(DashBoard.this, ListChatActivity.class));
        });
