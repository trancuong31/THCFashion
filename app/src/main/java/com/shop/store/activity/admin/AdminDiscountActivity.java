...
public class AdminDiscountActivity extends AppCompatActivity {
    ...
    TextInputEditText txtAdIdDiscount,
            ...
            txtAdValueDiscount,
            txtAdStatusDiscount, txtStartTime, txtEndTime;
    Button btnAdd,
            btnDelete,
            btnUpdate;
    ImageView btnBack;
...
//        CreateData create = new CreateData(this);
    ...
    private void insertData() {
        ...
        DiscountStatus discountStatus = new DiscountStatus(value,startTime,endTime);
        String json = new Gson().toJson(discountStatus);
        ...
        try {
            ...
            if (!validate(id, productId, json)) {
                Toast.makeText(AdminDiscountActivity.this, "Nhập thông tin sai", Toast.LENGTH_SHORT).show();
                return;
            } else {
                Discount discount = new Discount(Integer.parseInt(id), Integer.parseInt(productId), Float.parseFloat(value), json);
