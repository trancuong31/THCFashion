...
import static com.shop.store.utilities.AccountSessionManager.account;
import static com.shop.store.utilities.AccountSessionManager.user;
import static com.shop.store.utilities.AppUtilities.PERMISSION_REQUEST_CODE;
import static com.shop.store.utilities.AppUtilities.TAKE_PICTURE;
import static com.shop.store.utilities.AppUtilities.requestPermission;
...
//            updateEmail(email);
    ...
    private boolean validate(@NotNull String fullName, String phone, String address) {
        ...
        if (fileImage == null) {
            fileImage = Uri.parse("android.resource://com.shop.store/drawable/account");
        }
        return true;
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (resultCode == FirebaseActivity.CHANGE_EMAIL_OK) {
            if (requestCode == FirebaseActivity.CHANGE_EMAIL) {
                Toast.makeText(this, "Đã cập nhật thông tin thành công.", Toast.LENGTH_SHORT).show();
                finish();
            }
        }
