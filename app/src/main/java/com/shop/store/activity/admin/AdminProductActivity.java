...
public class AdminProductActivity extends AppCompatActivity {
    ...
    private TextInputEditText txtAdIdProduct,
            txtAdStoreId,
            txtAdType,
            txtAdNameProduct,
            txtAdPriceProduct,
    ...
    private void insertData() {
        ...
        JsonDataDetails jsonDataDetails = new JsonDataDetails(detail, txtColor.getText().toString(), txtSize.getText().toString());
        String jsonDetails = new Gson().toJson(jsonDataDetails);
    ...
    private void updateData() {
        ...
        try {
            ...
            String json = new Gson().toJson(new JsonDataDetails(detail,txtColor.getText().toString(),txtSize.getText().toString()));

            Product product = new Product(Integer.parseInt(id), Integer.parseInt(store), Integer.parseInt(type), name, Double.parseDouble(price),
                    image, json, star, status);
            ProductDbHelper productDbHelper = new ProductDbHelper(this);
