package com.shop.store.fragment;
...
import com.shop.store.adapter.RecyleItemViewAdapter;
import com.shop.store.model.MenuItem;
import com.shop.store.utilities.ImageConverter;

public class MenuFragment extends Fragment implements RecyleItemViewAdapter.ClassFinish {
...
//        menuAvatar.setImageBitmap(user.getAvatar());
    ...
    private void setMenuItemSection(@NotNull View view) {
        ...
        RecyleItemViewAdapter adapter = new RecyleItemViewAdapter(lstMenuItems, this);
    ...
    @Override
    public void sendData(boolean check) {
        getActivity().finish();
    }
}